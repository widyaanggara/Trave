        ...
        <div class="w-full mt-8">
            <div class="grid grid-cols-1 md:grid-cols-[75%,1fr] lg:grid-cols-[57%,1fr] gap-4">
                <div class="">
                    ...
                    <div class="mt-4">Wisata bahari menawarkan pengalaman luar biasa yang menghubungkan Anda langsung dengan keindahan laut Bali. Dalam kategori ini, Anda akan menemukan berbagai destinasi pesisir yang menakjubkan, mulai dari pantai berpasir putih hingga kawasan untuk snorkeling dan diving yang kaya akan kehidupan laut. Keindahan bawah laut Bali, dengan terumbu karang yang memukau dan keanekaragaman ikan tropis, menjadikan wisata bahari sebagai pilihan utama bagi para pecinta alam dan petualangan. Setiap lokasi menawarkan pesona laut yang berbeda, dengan aktivitas yang dapat dinikmati oleh semua kalangan. Jelajahi kategori Wisata Bahari untuk merasakan keajaiban laut Bali yang memikat, dan temukan petualangan yang tak terlupakan di setiap ombak dan pasirnya.</div>
                </div>
                <div class=""></div>
            </div>
        </div>
