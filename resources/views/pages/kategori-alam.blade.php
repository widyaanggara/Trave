...
<body>
    ...
    <section class="w-[90%] max-w-[1200px] mx-auto flex flex-col justify-center items-center">
        <div class="mt-20 w-full">
            <img src="{{ asset('images/banner-alam.png') }}" alt="" class="object-cover w-full h-80 lg:h-full rounded-lg">
        </div>
    ...
    <section class="w-[90%] max-w-[1200px] mx-auto mt-14 mb-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            @foreach($destinasiAlam as $destination)
            <a href="{{ route('destinasi.showDetailAlam', $destination->id_destinasi) }}" class="">
